...
class MainAgent(Agent):
    ...
    def __init__(self):
        self.grid = HacktrickGridworld.from_layout_name('quarter_final_collaborative')
        self.ingr = []
        self.tick = 0
        self.flag=1
        self.wait = False
    ...
    def make_action(self,pos,target,orient):
        ...
        if(self.is_on_y(target)): #checkthe final orientation of the 
            ...
            if(x==0 or (self.obs == True and y != 0)):
